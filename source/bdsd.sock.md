...
**5. Check with [bdsd-cli](./bdsd-cli.html)**
...
Further information you can find in repo: [bdsd.client](./bdsd.client.html)

## Usage with other programming languages

For other programming languages you may implement client-side library which should communicate with IPC following [Bobaos Datapoint Sdk Message Protocol](./bdsm.html).
